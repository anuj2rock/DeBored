...
public class SpeechActivity extends Activity {
  ...
  private static final float DETECTION_THRESHOLD = 0.90f;
  ...
  private HashMap<String,String> displayedLabels = new HashMap<String, String>();
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    try {
      ...
      while ((line = br.readLine()) != null) {
        ...
        if (line.charAt(0) != '_') {
          displayedLabels.put(line.split("~")[0],line.split("~")[1]);
        }
      }
      br.close();
    } catch (IOException e) {
          ...
          new Runnable() {
            ...
            public void run() {
              ...
              if (!result.foundCommand.startsWith("_") && result.isNewCommand) {
                ...
                textView.setText(result.foundCommand+" "+displayedLabels.get(result.foundCommand).toString());
              }
            }
          });
      try {
